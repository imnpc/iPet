            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                    ...
                    <select name="species" required class="ui-select">
                        ...
                        <option value="狗" {{ old('species') === '狗' ? 'selected' : '' }}>🐶 狗</option>
                        <option value="猫" {{ old('species') === '猫' ? 'selected' : '' }}>🐱 猫</option>
                        <option value="兔子" {{ old('species') === '兔子' ? 'selected' : '' }}>🐰 兔子</option>
                        <option value="仓鼠" {{ old('species') === '仓鼠' ? 'selected' : '' }}>🐹 仓鼠</option>
                        <option value="其他" {{ old('species') === '其他' ? 'selected' : '' }}>其他</option>
                    </select>
                </div>
                <div>
